...
parser.add_argument('--datafolder', type=str, default='./dataset/DrugBank/random', help='drug_protein data path')
parser.add_argument('--datafolder_pt', type=str, default='./dataset/DrugBank', help='drug and protein data path')
parser.add_argument('--result_path', type=str,default='./result/DrugBank_random_BENCHMARK/',help='path to save results')
...
parser.add_argument('--classification_task',type=bool, default=True, help='True if classification else False') 
...
protein_path = os.path.join(args.datafolder_pt,'protein.pt')
...
ligand_path = os.path.join(args.datafolder_pt,'ligand.pt')
